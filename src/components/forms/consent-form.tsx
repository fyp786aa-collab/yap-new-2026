...
export function ConsentForm({ userId, userEmail }: ConsentFormProps) {
  ...
  const consent2 = watch("consent_availability");
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {/* Consent 2: Availability */}
        <Card
          className={
            errors.consent_availability ? "border-red-300 bg-red-50/30" : ""
          }
        >
          <CardContent className="pt-5 pb-4">
            <div className="flex items-start gap-3">
              <Checkbox
                id="consent_availability"
                checked={consent2 === true}
                onCheckedChange={(checked) =>
                  setValue(
          ...
          <CardContent className="pt-5 pb-4">
            <div className="flex items-start gap-3">
              ...
              <label
                ...
                className="text-sm leading-relaxed cursor-pointer"
              >
                I confirm that all responses in this application are truthful,
                written by me, and not generated by AI tools. I understand that
